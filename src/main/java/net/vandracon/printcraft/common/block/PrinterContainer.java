...
public class PrinterContainer extends Container {
    ...
    public PrinterContainer(int windowId, World world, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player) {
        super(ModContainers.PRINTER_CONTAINER.get(), windowId);
